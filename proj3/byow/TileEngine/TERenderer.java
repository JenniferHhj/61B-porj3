...
//
//        Font tinyPlain = new Font("Monaco", Font.PLAIN, 25);
//        StdDraw.setFont(tinyPlain);
//        StdDraw.setPenColor(Color.cyan);
//        TETile t;
//        double xPos = .5;
//        double yPos = .5;
//        double w = width * TILE_SIZE;
//        double h = height * TILE_SIZE;

//        if (xPos < 1 && xPos > 0 && yPos > 0 && yPos < 1) {
//            t = world[(int) ((int) xPos * w)][(int) ((int) yPos * h)];
//            StdDraw.text(.8, .5, "Tile: " + t.description());
//        }
//
//        while (xPos < 1 && xPos > 0 && yPos > 0 && yPos < 1) {
//            System.out.println(StdDraw.mouseX() + "   " + StdDraw.mouseY());
//            if (xPos * width < 80 && yPos * height < 30) {
//                t = world[(int) StdDraw.mouseX() * width][(int) StdDraw.mouseY() * height];
//                StdDraw.text(.8, .5, "Tile: " + t.description());
//                StdDraw.show();
//            }
//            xPos = StdDraw.mouseX();
